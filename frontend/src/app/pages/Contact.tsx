...
export function Contact() {
  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="max-w-7xl mx-auto space-y-16 sm:space-y-24 pt-10 sm:pt-20">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 relative">
          ...
          <div className="bg-white rounded-[1.75rem] sm:rounded-[3rem] p-6 sm:p-10 shadow-[0_8px_32px_rgba(88,88,88,0.02)]">
            ...
            <form className="space-y-6">
              ...
              <a
                ...
                className="w-full py-3.5 sm:py-4 bg-[#E84C3D] hover:bg-[#C0392B] text-white rounded-full text-base sm:text-lg font-semibold hover:shadow-[0_12px_40px_rgba(117,162,158,0.2)] transition-all flex items-center justify-center gap-2"
              >
        ...
        <motion.div variants={itemVariants} className="space-y-8 relative z-10 flex flex-col justify-center">
          <div className="bg-[#FDEBD0] rounded-[1.75rem] sm:rounded-[3rem] p-6 sm:p-10 flex items-start gap-4 sm:gap-6 border border-white/50">
          ...
          <div className="bg-[#FDF3E6] rounded-[1.75rem] sm:rounded-[3rem] p-6 sm:p-10 flex items-start gap-4 sm:gap-6 border border-white/50">
            <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center shrink-0">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-white rounded-[1.75rem] sm:rounded-[3rem] p-6 sm:p-10 flex items-start gap-4 sm:gap-6 border border-black/5 hover:shadow-[0_12px_40px_rgba(88,88,88,0.08)] transition-all"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#FDEBD0] rounded-[1.75rem] sm:rounded-[3rem] p-6 sm:p-10 flex items-start gap-4 sm:gap-6 border border-white/50 hover:shadow-[0_12px_40px_rgba(88,88,88,0.08)] transition-all"
          >
            <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center shrink-0">
          ...
          <div className="bg-white rounded-[1.75rem] sm:rounded-[3rem] p-6 sm:p-10 flex items-start gap-4 sm:gap-6 border border-black/5">
            <div className="w-14 h-14 bg-[#FFF5EA] rounded-full flex items-center justify-center shrink-0">
